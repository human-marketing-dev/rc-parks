...
/**
 * Íconos de marca en SVG inline: el proyecto no usa librería de íconos, así que
 * evitamos sumar una dependencia por tres logos. Trazos de Simple Icons (24×24).
 */
...
export function SocialLinks({ label }: { label: string }) {
  return (
    <ul aria-label={label} className="flex items-center gap-2.5">
